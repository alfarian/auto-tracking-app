...
LOGO HERE            </router-link>
            ...
            <ul class="navbar-nav navbar-nav-hover align-items-lg-center">
                    ...
                    <div class="dropdown-menu-inner">
                        ...
                        <a href="https://google.com"
                           class="media d-flex align-items-center">
                            ...
                            <div class="media-body ml-3">
                                <h5 class="heading text-warning mb-md-1">Drivers list</h5>
                ...
                <base-dropdown tag="li" class="nav-item">
                    ...
                    <router-link to="/login" class="dropdown-item">Login Driver</router-link>
                    <router-link to="/register" class="dropdown-item">Register Driver</router-link>
                </base-dropdown>
            </ul>
